...
return(
    <div style={{overflow:`hidden`}} id="about" className="about-container">
         <div className="about-text-box">
            <h2>Hi, I'm June</h2>
            <p>Thank you for stopping by. I'm a frontend &amp; fullstack developer, musician, and dabbler from Durham, NC. I have a passion for design and art and bring that into my work.</p>
